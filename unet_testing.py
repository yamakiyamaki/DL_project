# train.py
# Execution command: python3 unet_testing.py --e 50 --mn model_name.pth --lr 0.001 --bs 16 --loss ssim --sche 1
import sys
import os
...
from UnetModelGenerator import CustomUNet
...
model = CustomUNet(in_channels=3, out_channels=3)
