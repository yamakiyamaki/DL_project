...
def split_dataset(data_root, train_ratio=0.7, val_ratio=0.1, random_seed=351):
    ...
    print(
        f"Split dataset: {len(train_face_ids)} faces for training, {len(val_face_ids)} faces for validation, {len(test_face_ids)} faces for testing"
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--data_dir",
        type=str,
        default="./data/dataset_256px_16f_100im/",
